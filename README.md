...
เมนู `/screener` เลือกถือยาว ปันผล หรือเทรดสั้นได้ กดค้นหาหุ้นอัตโนมัติจากรายชื่อที่แอปจัดเตรียมไว้ตลาดละ 30 บริษัท หรือเลือก Watchlist ของตลาด US/BKK สูงสุดครั้งละ 30 ตัว โดยไม่ต้องกรอกชื่อหุ้น และเพิ่มผลลัพธ์เข้า Watchlist ได้ ระบบเรียกข้อมูลพร้อมกันไม่เกิน 3 ตัวและแสดงผลที่โหลดล้มเหลวแยกต่างหาก
...
รายชื่อสำหรับค้นหาอัตโนมัติอยู่ใน `src/lib/discovery-universe.ts` เป็นกลุ่มบริษัทที่ดูแลด้วยตนเอง ไม่ใช่รายชื่อสมาชิกดัชนีปัจจุบันหรือการค้นหาทั้งตลาด
